...
public class VirtualCommandPrompt
{
	...
	public static void virtualCommandPrompt()
	{
		...
		while(true)
		{
			...
			switch(commandWords[0])
			{
				...
				case "bk": if(currentDirectory.getName() != "R:")
					   	   {
				...
				default: System.out.println(signature + ">Command does not exist");
					 	 System.out.print(signature + ">");
	...
	{		
		Iterator<Directory> iterator = currentDirectory.getListOfSubDirectory().iterator();
