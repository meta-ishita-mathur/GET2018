...
public class UpdateUserProfileDataController extends HttpServlet
{
	...
	{	
		String name, contact, org, email, message = ""; 
		int age;
		
		name = (String) request.getParameter("update_name");
		age = (Integer) request.getParameter("update_age");
		contact = (String) request.getParameter("update_contact");
		org = (String) request.getParameter("update_org");
		...
		switch(status)
		{
			...
			case ERROR: message = "got some error ";
						break;
			case NOT_FOUND: break;
			case OK: break;
			case UPDATED: message = "data has been updated ";
						  break;
			default: break;
		}
